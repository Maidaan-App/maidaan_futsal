...
const SCNSingleImagePicker = ({
  ...
  if (variant === "standard") {
    ...
    return (
      <div className="flex flex-col gap-2">
        ...
        {selectedImage == null ? (
          <>
            <div
              className="w-auto dark:bg-gray-700 border h-60 gap-4 rounded-lg flex flex-col justify-center items-center hover:bg-slate-100 duration-300"
    ...
    return (
      <div className="flex flex-col gap-2">
        <Label htmlFor={schemaName}>{name}</Label>
        <div className="w-auto  h-60 gap-4 rounded-lg flex flex-col justify-center items-center ">
          {selectedImage ? (
            <AnimatePresence>
              <motion.div
